// src/components/Students/ReservarEquipoPage.jsx
...
export default function ReservarEquipoPage() {
  ...
  const handleClickCam = (id) => {
    navigate(`/reservar-equipo/${id}`);
  };

  return (
    <div className="students-root students-root-fixed-footer">
      <Header />
